...
const AdminDashboard = () => {
  ...
  const quickLinks = [
    ...
    { icon: <Stethoscope />, label: "Patients", path: "/dashboard/admin/patients" },
    { icon: <Settings2 />, label: "Settings", path: "/dashboard/admin/settings" },
    { icon: <PlusCircle />, label: "Manage Doctors", path: "/dashboard/admin/manage-doctors" },
    { icon: <UserCog />, label: "Manage Users", path: "/dashboard/admin/manage-users" },
  ...
  return (
    <div className={`min-h-screen transition-colors ${darkMode ? "bg-gray-900 text-yellow-400" : "bg-hospital-light text-hospital-primary"}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="flex justify-between items-center mb-10 animate-fade-in">
          <div>
            <h1 className={`text-4xl font-bold mb-2 ${textColor}`}>Admin Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <Card className="bg-gradient-to-r from-green-50 to-green-100">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 dark:text-gray-200 mb-4">
                Use predictive analysis to detect anomalies in patient vitals and generate early disease warnings.
              </p>
              <Button variant="outline" className="w-full">Launch AI Tool</Button>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-r from-indigo-50 to-indigo-100">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 dark:text-gray-200 mb-4">
                Instant messaging between doctors, staff, and administration for better coordination.
              </p>
              <Button variant="outline" className="w-full"><MessageSquare className="mr-2 h-4 w-4" /> Open Chat</Button>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-r from-sky-50 to-sky-100">
            ...
            <CardContent>
              <p className="text-sm text-gray-700 dark:text-gray-200 mb-4">
                Export system logs, audit trails, and operational reports with one click.
              </p>
              <Button variant="outline" className="w-full"><HardDriveDownload className="mr-2 h-4 w-4" /> Export Data</Button>
            </CardContent>
          </Card>
        </div>
          ...
          {[{ icon: <UserCircle />, label: "Total Patients", value: "1,247" },
            ...
            <Card key={idx}>
              <CardContent className="p-6 text-center">
                <div className={`flex justify-center text-2xl mb-2 ${textColor}`}>
                  {item.icon}
                </div>
                <div className={`text-3xl font-bold mb-1 ${textColor}`}>{item.value}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-10">
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button className="w-full bg-hospital-primary text-white">User Management</Button>
              <Button variant="outline" className="w-full">Department Settings</Button>
              ...
              <Button variant="outline" className="w-full" onClick={() => navigate("/dashboard/admin/manage-doctors")}>Manage Doctors</Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button className="w-full bg-yellow-400 text-black">Generate Monthly Report</Button>
              <Button variant="outline" className="w-full">Financial Dashboard</Button>
              <Button variant="outline" className="w-full">Performance Metrics</Button>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button className="w-full bg-red-600 text-white">System Alert</Button>
              <Button variant="outline" className="w-full border-red-500 text-red-600">Emergency Shutdown</Button>
        ...
        <Card className="mb-10">
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="bg-green-100 p-4 rounded">Security scan completed - No threats detected</li>
              <li className="bg-yellow-100 p-4 rounded">Last backup completed 2 hours ago</li>
              <li className="bg-blue-100 p-4 rounded">Firewall is active and updated</li>
            </ul>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-hospital-light dark:bg-gray-800 rounded">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">30 minutes ago</p>
                </div>
